...
<script src="../assets/admin_assets/jquery-ui/jquery-ui.min.js"></script>
...
<script src="../assets/admin_assets/chart.js/Chart.min.js"></script>

<script src="../assets/admin_assets/sparklines/sparkline.js"></script>

<script src="../assets/admin_assets//jqvmap/jquery.vmap.min.js"></script>
<script src="../assets/admin_assets/jqvmap/maps/jquery.vmap.usa.js"></script>

<script src="../assets/admin_assets/jquery-knob/jquery.knob.min.js"></script>

<script src="../assets/admin_assets/moment/moment.min.js"></script>
<script src="../assets/admin_assets/daterangepicker/daterangepicker.js"></script>

<script src="../assets/admin_assets/tempusdominus-bootstrap-4/js/tempusdominus-bootstrap-4.min.js"></script>

<script src="../assets/admin_assets/summernote/summernote-bs4.min.js"></script>

<script src="../assets/admin_assets/overlayScrollbars/js/jquery.overlayScrollbars.min.js"></script>

<script src="../assets/admin_assets/js/adminlte.js?v=3.2.0"></script>

<script src="../assets/admin_assets/js/demo.js"></script>

<script src="../assets/admin_assets/js/pages/dashboard.js"></script>
