...
class HomeController extends CI_Controller
{
	...
	public function course_table()
	{
		$data['address1'] = $this->db->get("address1")->result();
		$data['address2'] = $this->db->get("address2")->result();
		$this->load->view('frontend/5th-6th-course', $data);
	}
	public function study()
	{
		$data['address1'] = $this->db->get("address1")->result();
		$data['address2'] = $this->db->get("address2")->result();
		$this->load->view('frontend/study', $data);
	}
	...
	public function syllabus()
	{
		$data['address1'] = $this->db->get("address1")->result();
		$data['address2'] = $this->db->get("address2")->result();
		$this->load->view('frontend/syllabus',$data);
	}
	public function scholarship_form()
	{
		$data['address1'] = $this->db->get("address1")->result();
		$data['address2'] = $this->db->get("address2")->result();
		$this->load->view('frontend/scholarship',$data);
	}
	...
	public function fees()
	{
		$data['address1'] = $this->db->get("address1")->result();
		$data['address2'] = $this->db->get("address2")->result();
		$this->load->view('frontend/fees', $data);
	}
