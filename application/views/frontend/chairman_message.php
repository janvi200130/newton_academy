        ...
        <div class="row align-items-center">
            <div class="col-lg-12 animation" data-animation="fadeInUp" data-animation-delay="0.3s">
                ...
                <div class="about_section pl-lg-3">
              		<p style="text-align: justify;">In today's world where even educational institutes have lost sight of their noble ideals in a madrush for making money, we take pride in introducing ourselves as an academy committed to the idea of excellence in education.</p>
