			...
			<div class="row">
				...
				<div class="col-12">
					...
					<div class="text-right">
						<a href="all-courses" class="btn btn-info my-2">All Courses</a>
					</div>
						...
						<form action="" method="post" enctype="multipart/form-data">
							<div class="card-body">
								<div class="form-group">
									<label for="exampleInputFile">Add Course</label>
									<div class="input-group">
										<div class="custom-file">
											<label class="form-label" for="exampleInputFile"></label>
											<input type="input" name="gallery_image" class="form-control" id="exampleInputFile" placeholder="Choose file" required>
										</div>
									</div>
								</div>
							</div>
